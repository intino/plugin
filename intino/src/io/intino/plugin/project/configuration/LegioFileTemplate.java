...
public class LegioFileTemplate extends Template {
	...
	public RuleSet ruleSet() {
		return new RuleSet().add(
			...
			rule().condition((type("factory"))).output(literal("Model(language = \"")).output(mark("dsl")).output(literal("\", version = \"")).output(mark("dslVersion")).output(literal("\", sdk = \"")).output(expression().output(mark("sdk")).next(expression().output(literal("LATEST")))).output(literal("\")")),
