...
public class PsiCustomWordRule implements VariableRule<Object>, CustomRule {
	...
	private PsiClass findClass() {
		...
		return JavaPsiFacade.getInstance(variable.getProject()).findClass(IntinoUtil.dslGenerationPackage(variable).toLowerCase() + ".rules." + destiny, GlobalSearchScope.moduleScope(module));
	}
