...
public class ExportOSProcessHandler {
	private static final Logger LOG = getInstance(ExportOSProcessHandler.class);
	...
	ExportOSProcessHandler(Process process, Module module, Configuration.Artifact.Dsl dsl, ProgressIndicator indicator) {
	...
	private void processMessage() {
		...
		CompilerMessage compilerMessage = new CompilerMessage(dsl.artifactId(), kind, message, url, -1, -1, -1, lineInt, columnInt);
	...
	protected class SimpleOutputReader extends BaseOutputReader {
		...
		public SimpleOutputReader(Reader reader, Options options, @NotNull String presentableName) {
