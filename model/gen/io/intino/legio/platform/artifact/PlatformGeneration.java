package io.intino.legio.platform.artifact;

import io.intino.legio.*;


public class PlatformGeneration extends io.intino.legio.level.artifact.LevelGeneration implements io.intino.tara.magritte.tags.Terminal {
	

	public PlatformGeneration(io.intino.tara.magritte.Node node) {
		super(node);
	}
