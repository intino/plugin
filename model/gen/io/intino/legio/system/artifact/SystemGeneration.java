package io.intino.legio.system.artifact;

import io.intino.legio.*;


public class SystemGeneration extends io.intino.legio.level.artifact.LevelGeneration implements io.intino.tara.magritte.tags.Terminal {
	

	public SystemGeneration(io.intino.tara.magritte.Node node) {
		super(node);
	}
