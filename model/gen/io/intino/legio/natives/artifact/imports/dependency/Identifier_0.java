...
public class Identifier_0 implements io.intino.tara.magritte.Expression<String> {
	private io.intino.legio.Artifact.Imports.Dependency self;
	...
	public void self(io.intino.tara.magritte.Layer context) {
		self = (io.intino.legio.Artifact.Imports.Dependency) context;
	}

	@Override
	public Class<? extends io.intino.tara.magritte.Layer> selfClass() {
		return io.intino.legio.Artifact.Imports.Dependency.class;
	}
}