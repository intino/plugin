...
public class PlatformArtifact extends io.intino.legio.graph.level.LevelArtifact implements io.intino.tara.magritte.tags.Terminal {
	...
	public PlatformArtifact groupId(java.lang.String value) {
		this._artifact.groupId(value);
		return (PlatformArtifact) this;
	}

	public PlatformArtifact version(java.lang.String value) {
