...
public abstract class LevelArtifact extends io.intino.tara.magritte.Layer implements io.intino.tara.magritte.tags.Terminal {
	...
	public class Create  {
		...
		public io.intino.legio.graph.level.LevelArtifact.Model model(java.lang.String language, java.lang.String version, java.lang.String sdk) {
		    io.intino.legio.graph.level.LevelArtifact.Model newElement = core$().graph().concept(io.intino.legio.graph.level.LevelArtifact.Model.class).createNode(this.name, core$()).as(io.intino.legio.graph.level.LevelArtifact.Model.class);
