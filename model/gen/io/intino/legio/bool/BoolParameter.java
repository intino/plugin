...
public class BoolParameter extends io.intino.legio.type.TypeParameter implements io.intino.tara.magritte.tags.Terminal {
	protected boolean value;

	public BoolParameter(io.intino.tara.magritte.Node node) {
		super(node);
	}
	...
	protected void _load(java.lang.String name, java.util.List<?> values) {
		...
		if (name.equalsIgnoreCase("value")) this.value = io.intino.tara.magritte.loaders.BooleanLoader.load(values, this).get(0);
	}
